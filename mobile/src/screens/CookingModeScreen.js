...
const mockSteps = [
  ...
  { number: 3, text: 'In the same skillet, sauté minced garlic until fragrant. Add sun-dried tomatoes and spinach.', time: '3:00' },
];
      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="px-6 py-4 flex-row items-center justify-between">
          ...
          <View className="items-center">
            ...
            <Text className="text-gray-400 text-[10px]">Step {currentStep + 1} of {steps.length}</Text>
          </View>
          <View className="w-8" />
        </View>
        ...
        <View className="p-8 flex-row justify-between items-center">
          ...
          {currentStep === steps.length - 1 ? (
            <TouchableOpacity 
              ...
              className="bg-primary px-10 py-4 rounded-2xl shadow-lg shadow-green-900"
            >

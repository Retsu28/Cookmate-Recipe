  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-stone-900 dark:text-stone-50 sm:text-4xl">{title}</h1>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-stone-500 dark:text-stone-400 sm:text-base">{description}</p>
      </div>

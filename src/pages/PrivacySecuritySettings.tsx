...
const STORAGE_KEY = 'cookmate.privacySecuritySettings';
...
const dataRows: Array<{
...
}> = [
  {
    ...
    description: 'Use your saved tastes and cooking skill to tune recipe recommendations.',
    icon: Sparkles,
  },
  {
    id: 'cookingActivityInsights',
  ...
  },
  {
    ...
    description: 'Share basic reliability signals to help improve app stability.',
    icon: Activity,
  },
];
...
function SecurityActionRow({ title, description, icon: Icon, action }: SecurityActionRowProps) {
  return (
    <div className="flex flex-col gap-4 rounded-lg border border-stone-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex min-w-0 items-start gap-3">
        <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-stone-100 text-stone-700">
          <Icon className="size-5" />
        </div>
        <div className="min-w-0">
          <h3 className="text-base font-extrabold text-stone-900">{title}</h3>
          <p className="mt-1 text-sm font-medium leading-relaxed text-stone-500">{description}</p>
        </div>
      </div>
      {action}
    </div>
...
export default function PrivacySecuritySettings() {
  ...
  const [preferences, setPreferences] = useState<PrivacyPreferences>(() =>
    readStoredSettings(STORAGE_KEY, defaultPrivacyPreferences)
  );
  ...
  const savePreferences = () => {
    ...
    toast.success('Privacy and security settings saved.');
  };
        ...
        <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            ...
            <p className="mt-2 max-w-2xl text-base font-medium text-stone-500 md:text-lg">
              Manage data sharing and security options.
            </p>
          </motion.div>
        </div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="mb-6 flex items-start gap-3">
                ...
                <div>
                  <h2 className="text-lg font-extrabold text-stone-900">Data sharing</h2>
                  <p className="text-sm font-medium text-stone-500">
                    Control how your CookMate activity can personalize the app.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="mb-6 flex items-start gap-3">
                ...
                <div>
                  <h2 className="text-lg font-extrabold text-stone-900">Security options</h2>
                  <p className="text-sm font-medium text-stone-500">
                    Review account protection and data controls.
                  </p>
                </div>
              </div>
              ...
              <div className="grid gap-3">
                <SecurityActionRow
                  ...
                  description="Change your email or password from settings."
                  icon={KeyRound}
                  action={
                    <Link
                      to="/settings"
                ...
                <SecurityActionRow
                  ...
                  description="Prepare a copy of your saved profile and preference data."
                  icon={Download}
                  action={
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => toast.success('Account data request prepared.')}
                      className="h-10 shrink-0 rounded-lg border-stone-200 px-4 font-bold text-stone-700"
                    >
                      Request
                    </Button>
                  }
                ...
                <SecurityActionRow
                  ...
                  description="Check that your protected account settings are current."
                  icon={ShieldCheck}
                  action={
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => toast.success('Security review completed.')}
                      className="h-10 shrink-0 rounded-lg border-stone-200 px-4 font-bold text-stone-700"
                    >
                      Review
                    </Button>
          ...
          >
            <div className="mb-5 flex items-center gap-3 border-b border-stone-100 pb-5">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-stone-500">Data sharing options</p>
              </div>
            </div>
